		...
		<div class="col-lg-9 col-md-9 col-lg-offset-3 col-md-offset-3">
			<div class="row">
				<h1 class="fs_33 h_37_ThinC mt_30">
					¿Qué <span class="fc_2bb673 h_47_LightC">Playlist</span> deseas reproducir desde tu servidor?
				</h1>
					...
					<div class="borde_total">
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
								@include('video.listados.playlist_locales')
							</div>
						</div>
						@include('video.modales.playlist_locales')
					</div>
				</div>
			</div>
		</div>
