		...
		<div class="col-lg-9 col-md-9 col-lg-offset-3 col-md-offset-3">
			<div class="row">
				<h1 class="fs_33 h_37_ThinC mt_30">
					¿Cuál es el <span class="fc_2bb673 h_47_LightC">Origen</span> de los  
					<span class="fc_2bb673 h_47_LightC">Turnos</span> atendidos?
				</h1>
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
								<div class="overflow mb_30 mt_20">
									<img src="{{ asset('img/reportes_origen.jpg') }}" alt="" class="img-responsive">
								</div>
								<table class="table table-responsive table-default table-select">
									<thead class="h_Cond">
										<tr>
											...
											<th class="borde_cabecera_tabla text-center fc_97bbcd">Turnos kiosco</th>
											<th class="borde_cabecera_tabla text-center fc_e1ae6c">Turnos app móvil</th>
											<th class="borde_cabecera_tabla text-center fc_7fd0d9">Total turnos generados</th>
