		...
		<div class="col-lg-9 col-md-9 col-lg-offset-3 col-md-offset-3">
			<div class="row">
				<h1 class="fs_33 h_37_ThinC mt_30">
					¿Cuáles son los <span class="fc_2bb673 h_47_LightC">Promedios</span> en la atención de 
						...
						<div class="row">
							<div class="col-lg-12 col-md-12">
								<div class="overflow mb_30 mt_20">
									<img src="{{ asset('img/reportes_promedio.jpg') }}" alt="" class="img-responsive">
								</div>
								<table class="table table-responsive table-default table-select">
									<thead class="h_Cond">
										<tr>
											...
											<th class="borde_cabecera_tabla text-center fc_7fd0d9">Minutos atendidos</th>
											<th class="borde_cabecera_tabla text-center fc_7fd0d9">Turnos atendidos</th>
											<th class="borde_cabecera_tabla text-center fc_97bbcd">Minutos por turno</th>
